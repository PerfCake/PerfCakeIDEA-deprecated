 ...
 */
public class TempFactory implements ScenarioFactory {
    ...
    public void init(org.perfcake.model.Scenario scenario1) throws PerfCakeException {
        this.scenarioModel = scenario1;
    }
    ...
    protected RunInfo parseRunInfo() throws PerfCakeException {
        org.perfcake.model.Scenario.Generator gen = scenarioModel.getGenerator();
        org.perfcake.model.Scenario.Generator.Run run = gen.getRun();
    ...
    /**
     * Parse the <code>sender</code> element into a {@link org.perfcake.message.sender.MessageSenderManager} instance.
     *
    ...
    protected MessageSenderManager parseSender(final int senderPoolSize) throws PerfCakeException {
        ...
        org.perfcake.model.Scenario.Sender sen = scenarioModel.getSender();
        ...
        for (Map.Entry<Object, Object> sProperty : senderProperties.entrySet()) {
     ...
     *
     * @param validationManager ValidationManager carrying all parsed validators, these will be associated with the message templates.
     * @return Message store in a form of {@link Map}&lt;{@link org.perfcake.message.Message}, {@link Long}&gt; where the keys are stored messages and the values
    ...
    protected List<MessageTemplate> parseMessages(ValidationManager validationManager) throws PerfCakeException {
        ...
        try {
            org.perfcake.model.Scenario.Messages messages = scenarioModel.getMessages();
            if (messages != null) {

                log.info("--- Messages ---");
                for (org.perfcake.model.Scenario.Messages.Message m : messages.getMessage()) {
                    URL messageUrl = null;
                    ...
                    for (org.perfcake.model.Scenario.Messages.Message.ValidatorRef ref : m.getValidatorRef()) {
    ...
    protected ReportManager parseReporting() throws PerfCakeException {
        ...
        try {
            log.info("--- Reporting ---");
            org.perfcake.model.Scenario.Reporting reporting = scenarioModel.getReporting();
            if (reporting != null) {
                ...
                for (org.perfcake.model.Scenario.Reporting.Reporter r : reporting.getReporter()) {
                    if (r.isEnabled()) {
                        ...
                        for (org.perfcake.model.Scenario.Reporting.Reporter.Destination d : r.getDestination()) {
                            if (d.isEnabled()) {
    ...
    protected ValidationManager parseValidation() throws PerfCakeException {
        ...
        try {
            ...
            org.perfcake.model.Scenario.Validation validation = scenarioModel.getValidation();
            if (validation != null) {

                for (org.perfcake.model.Scenario.Validation.Validator v : validation.getValidator()) {
