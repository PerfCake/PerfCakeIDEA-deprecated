...
public class ReportingModel extends AbstractScenarioModel {
    ...
    /**
     * @return PerfCake Reporting oldmodel intended for read only.
     */
    ...
    /**
     * Deletes reporter object from this oldmodel. Reporter object should exist in this oldmodel.
     *
    ...
    public void deleteReporter(@NotNull Scenario.Reporting.Reporter reporter) {
        ...
        if (!success) {
            LOG.error(this.getClass().getName() + ": Reporter was not found in PerfCake JAXB oldmodel");
            return;
        }
