...
public class ValidationModel extends AbstractScenarioModel {
    ...
    /**
     * @return PerfCake Validation oldmodel intended for read only.
     */
    ...
    /**
     * Deletes validator object from this oldmodel. Validator object should exist in this oldmodel.
     *
    ...
    public void deleteValidator(@NotNull Scenario.Validation.Validator validator) {
        ...
        if (!success) {
            LOG.error(getClass().getName() + ": Validator " + validator.getClazz() + " was not found in PerfCake JAXB oldmodel");
            return;
        }
