...
public class SenderModel extends AbstractScenarioModel {
    ...
    /**
     * @return PerfCake sender oldmodel intended for read only.
     */
    @NotNull
    ...
    /**
     * Deletes property object from this oldmodel. Property object should exist in this oldmodel, otherwise error is logged.
     *
