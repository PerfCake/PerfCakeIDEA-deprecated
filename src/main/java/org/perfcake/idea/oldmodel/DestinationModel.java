...
public class DestinationModel extends AbstractScenarioModel {
    ...
    /**
     * @return PerfCake Destination oldmodel intended for read only
     */
    ...
    /**
     * Deletes period object from this oldmodel. Period object should exist in this oldmodel.
     *
    ...
    public void deletePeriod(@NotNull Scenario.Reporting.Reporter.Destination.Period period) {
        ...
        if (!success) {
            LOG.error(getClass().getName() + ": Period was not found in PerfCake JAXB oldmodel");
            return;
        }
