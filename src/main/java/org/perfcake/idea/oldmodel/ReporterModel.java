...
public class ReporterModel extends AbstractScenarioModel {
    ...
    /**
     * @return PerfCake Reporter oldmodel intended for read only.
     */
    ...
    /**
     * Deletes destination object from this oldmodel. Destination object should exist in this oldmodel.
     *
    ...
    public void deleteDestination(@NotNull Scenario.Reporting.Reporter.Destination destination) {
        ...
        if (!success) {
            LOG.error(this.getClass().getName() + ": Destination was not found in PerfCake JAXB oldmodel");
            return;
        }
    ...
    /**
     * Deletes property object from this oldmodel.
     *
